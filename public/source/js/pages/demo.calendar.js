...
// 	var CalendarApp = function ($calendarElement) {
// 		(this.$body = $("body")),
...
// 	/* on click on event */
// 	// Example modification in onEventClick
...
//     // Use this.$calendarObj instead of this.$calendar
//     this.$calendarObj = info.view.calendar;

//     // ...
// });

// // Similar adjustments in other event handling methods as needed
...
// 						$this.$selectedEvent.setProp("classNames", [
// 							$("#event-category").val(),
// 						]);
// 					} else {
// 						var eventData = {
...
// var calendar1 = new CalendarApp($("#taskcalendar"));
// calendar1.init();
// console.log("working")
console.logj(2+3)